    ...
    return "<h1 style='text-align: center'>Hello, World!</h1>" \
              "<p style='text-align: center'>This is a simple Flask application.</p>" \
                "<p style='text-align: center'>You can access different pages using the links below:</p>" \
                    "<img src='https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExdm9qaDVtaTl1NXhtaHRvZXllMTFhaWQ5cnF1Y3VvZ3I1OTN3endvbSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/njtPBlbYnHAHK/giphy.gif' alt='Kitten' width: 200px>" \
